...
class RainbowNet(nn.Module):
    def __init__(self, 
        ...
        self.out_conv1_dim = int((self.n_observations[1] - config['conv1-kernel-size'] \
    ...
    def predict(self, x):
        ...
        x = x.reshape(-1, self.n_observations[0], self.n_observations[1], self.n_observations[2])
